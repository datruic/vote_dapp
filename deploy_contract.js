...
// console.log('Estimate: ' + web3.eth.estimateGas({data: bytecode}) +  ', Price: ' + web3.eth.getGasPrice);
...
var myContractReturned = MyContract.new(['iPhoneX', 'Pixel 2', 'Galaxy S9', 'One plus 6', 'LG G7'], {
    from:senderAddress,
    data:bytecode,
